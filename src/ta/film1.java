 ...
 * @author rayan
 */
public class film1 extends javax.swing.JFrame {
 ...
 public Connection conn;
    ...
    public PreparedStatement pst;
       public film1() throws SQLException{
        initComponents();
        x = new koneksiDB();
        x.koneksi();
    ...
    void booking (String kode){
        ...
        sql = "INSERT INTO inputan(kodeKursi,film,studio,pendapatan) VALUES ('"+kodeKursi+"','"+film+"','"+studio+"','"+pendapatan+"')";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(film1.class.getName()).log(Level.SEVERE, null, ex);
        }
