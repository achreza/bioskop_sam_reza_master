 ...
 */
public class confirm_4 extends javax.swing.JFrame {
    koneksiDB x;
    public Connection conn;
    public ResultSet rs;
    public PreparedStatement pst;

    public confirm_4() throws Exception{
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txtKursi, javax.swing.GroupLayout.DEFAULT_SIZE, 203, Short.MAX_VALUE)
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(btnPrint1, javax.swing.GroupLayout.DEFAULT_SIZE, 163, Short.MAX_VALUE))))
                        .addGap(18, 18, 18)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(confirm_4.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       String id,sql;
        id = txtKursi.getText();
        sql = "delete from inputan4 where kodekursi='"+id+"'";
       ...
       confirm_4 bioskop = null;
        try {
            bioskop = new confirm_4();
        } catch (Exception ex) {
            Logger.getLogger(confirm_4.class.getName()).log(Level.SEVERE, null, ex);
        }
