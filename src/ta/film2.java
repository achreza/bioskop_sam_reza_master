 ...
 * @author rayan
 */
public class film2 extends javax.swing.JFrame {
   ...
   void cekAll(){
    ...
    void booking (String kode){
        ...
        sql = "INSERT INTO inputan2(kodeKursi,film,studio,pendapatan) VALUES ('"+kodeKursi+"','"+film+"','"+studio+"','"+pendapatan+"')";
    ...
    int cek(String kode){
        String sql;
        int ada = 1;
        sql = "SELECT kodekursi from inputan2 WHERE kodekursi='"+ kode +"' and studio = '"+ namaStudio +"';";
        try
        {
    ...
    private void initComponents() {
        ...
        txtharga.setFont(new java.awt.Font("Wingdings 3", 0, 3)); // NOI18N
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(hari, javax.swing.GroupLayout.PREFERRED_SIZE, 143, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel2Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addComponent(txtFilm, javax.swing.GroupLayout.PREFERRED_SIZE, 472, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(film2.class.getName()).log(Level.SEVERE, null, ex);
        }
