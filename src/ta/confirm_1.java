...
public class confirm_1 extends javax.swing.JFrame {
 ...
 public Connection conn;
    ...
    public confirm_1() throws Exception{
        initComponents();
        x = new koneksiDB();
        x.koneksi();
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/src/ta/icon.png"))); // NOI18N
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(btnPrint1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 155, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(confirm_1.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String id,sql;
        id = txtKursi.getText();
        sql = "delete from inputan where kodekursi='"+id+"'";
       ...
       confirm_1 bioskop = null;
        try {
            bioskop = new confirm_1();
        } catch (Exception ex) {
            Logger.getLogger(confirm_1.class.getName()).log(Level.SEVERE, null, ex);
        }
