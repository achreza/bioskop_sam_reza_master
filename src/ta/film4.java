 ...
 * @author rayan
 */
public class film4 extends javax.swing.JFrame {
 ...
 public Connection conn;
    ...
    public PreparedStatement pst;
       public film4() throws SQLException{
        initComponents();
        x = new koneksiDB();
        x.koneksi();
    ...
    void booking (String kode){
        ...
        sql = "INSERT INTO inputan4(kodeKursi,film,studio,pendapatan) VALUES ('"+kodeKursi+"','"+film+"','"+studio+"','"+pendapatan+"')";
    ...
    int cek(String kode){
        String sql;
        int ada = 1;
        sql = "SELECT kodekursi from inputan4 WHERE kodekursi='"+ kode +"' and studio = '"+ namaStudio +"';";
        try
        {
        ...
        jpanelLayout.setHorizontalGroup(
            ...
            .addGroup(jpanelLayout.createSequentialGroup()
                .addGroup(jpanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jpanelLayout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(txtFilm, javax.swing.GroupLayout.PREFERRED_SIZE, 503, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(film4.class.getName()).log(Level.SEVERE, null, ex);
        }
